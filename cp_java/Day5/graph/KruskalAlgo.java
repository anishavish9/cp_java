...
public class KruskalAlgo {
	...
	public static int KruskalAlgo(int n, int[][] edge) {
		...
		// array of all the edges containing pair of vertices and weight given 
		//to that edge.
		...
		for (int i = 0; i < edges.length; i++) {
			...
			//if vertices are from unique groups that implies , 
			//if both vertices would be connected, it won't create a loop.
			if (flag == false) {
