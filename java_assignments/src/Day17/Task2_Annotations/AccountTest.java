package Day17.Task2_Annotations;
...
public class AccountTest {
    ...
    public static void setUpClass() {
        System.out.println(
        	"Before Class annotation called: Setting up the class level resources");
    }
    ...
    public void setUp() {
        ...
        System.out.println(
        	"@Before annotation called for setting up the account for each test");
    }
